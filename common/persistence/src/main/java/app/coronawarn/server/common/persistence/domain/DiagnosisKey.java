...
public class DiagnosisKey {
  ...
  /**
   * Returns a number describing how long a key is valid. It is expressed
   * in increments of 10 minutes (e.g. 144 for 24 hours).
   */
  ...
  /**
   * Returns the timestamp associated with the submission of this {@link DiagnosisKey}
