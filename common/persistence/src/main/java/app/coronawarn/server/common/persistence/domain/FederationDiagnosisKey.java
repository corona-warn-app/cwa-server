...
import app.coronawarn.server.common.persistence.domain.FederationDiagnosisKeyBuilders.Builder;
 ...
 */
public class FederationDiagnosisKey {
   ...
   */
  FederationDiagnosisKey(byte[] keyData, int rollingStartIntervalNumber, int rollingPeriod,
                         int transmissionRiskLevel, long submissionTimestamp, List<String> visitedCountries,
                         String origin, VerificationType verficationType) {
    ...
    this.origin = origin;
    this.verificationType = verficationType;
  }

  /**
   * Returns a DiagnosisKeyBuilder instance. A {@link FederationDiagnosisKey}
   * can then be build by either providing the required
   * member values or by passing the respective protocol buffer object.
   *
   * @return DiagnosisKeyBuilder instance.
   */
  public static Builder builder() {
    return new FederationDiagnosisKeyBuilder();
  }
  ...
  /**
   * Returns the timestamp associated with the submission of this {@link FederationDiagnosisKey} as hours since epoch.
   */
   ...
   */
  public Set<ConstraintViolation<FederationDiagnosisKey>> validate() {
  ...
  public boolean equals(Object o) {
    ...
    FederationDiagnosisKey that = (FederationDiagnosisKey) o;
  ...
  public int hashCode() {
    int result = Objects
        .hash(rollingStartIntervalNumber, rollingPeriod, transmissionRiskLevel, submissionTimestamp, visitedCountries,
            origin, verificationType);
