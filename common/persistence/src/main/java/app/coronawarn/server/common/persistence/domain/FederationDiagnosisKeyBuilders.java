...
/**
 * This interface bundles interfaces that are used for the implementation of {@link FederationDiagnosisKeyBuilder}.
 */
interface FederationDiagnosisKeyBuilders {
  ...
  interface Builder {
     ...
     * @return this Builder instance.
     */
    FinalBuilder fromProtoBuf(DiagnosisKey protoBufObject);
  }
  ...
  interface FinalBuilder {
     ...
     * FederationDiagnosisKey#EXPECTED_ROLLING_PERIOD}
     *
    ...
    FinalBuilder withOrigin(String origin);

    FinalBuilder withVerificationType(VerificationType verificationType);

    /**
     * Builds a {@link FederationDiagnosisKey} instance. If no submission timestamp has been specified
     * it will be set to "now" as hours since epoch.
     */
    FederationDiagnosisKey build();
