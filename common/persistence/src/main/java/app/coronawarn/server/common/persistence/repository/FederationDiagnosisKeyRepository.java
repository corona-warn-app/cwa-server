...
@Repository
public interface FederationDiagnosisKeyRepository extends PagingAndSortingRepository<FederationDiagnosisKey, Long> {
   ...
   * @param visitedCountries           The visited countries while the diagnosis key was active.
   * @param origin                     The origin country of the diagnosis key.
   * @param validationType             The validation type of the diagnosis key.
   */
  @Modifying
  @Query("INSERT INTO diagnosis_key "
      ...
      +
      "visitedCountries, origin, validationType) "
      +
  ...
  void saveDoNothingOnConflict(
      ...
      @Param("visitedCountries") List<String> visitedCountries,
      @Param("origin") String origin,
      @Param("validationType") VerificationType validationType);
}
