...
class ChgsCallbackControllerTest {
  ...
  void shouldInsertBatchInfo() {
    ...
    assertThat(spyFederationClient.findByStatus(FederationBatchStatus.UNPROCESSED, CHGS))
        .contains(new FederationBatchInfo(batchTag, date, CHGS));
  }
