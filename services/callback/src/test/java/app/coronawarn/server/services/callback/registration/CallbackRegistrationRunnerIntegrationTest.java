...
class CallbackRegistrationRunnerIntegrationTest {
  ...
  void testRegistration() {
    ...
    verify(callbackServiceConfig, VerificationModeFactory.times(1)).isRegisterOnStartup();
    verify(callbackServiceConfig, VerificationModeFactory.times(1)).getEndpointUrl();
  }
}
