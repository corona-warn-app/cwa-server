...
public class TraceWarningPackageExportFile extends FileOnDiskWithChecksum {
  ...
  public TraceWarningPackageExportFile(
  ...
  public static TraceWarningPackageExportFile fromTraceTimeIntervalWarnings(
      Collection<TraceTimeIntervalWarning> traceTimeIntervalWarnings, String region,
      int intervalNumber, DistributionServiceConfig distributionServiceConfig) {
    return new TraceWarningPackageExportFile(
        getTraceIntervalWarningsFromTraceIntervalWarnings(traceTimeIntervalWarnings),
        region,
  ...
  private byte[] createTraceWarningExportBytes() {
    return TraceWarningPackage.newBuilder()
        .setIntervalNumber(this.intervalNumber)
        .setRegion(this.region)
        .addAllTimeIntervalWarnings(this.traceTimeIntervalWarnings)
        .build()
        .toByteArray();
  }
  ...
  private static Set<app.coronawarn.server.common.protocols.internal.pt.TraceTimeIntervalWarning> getTraceIntervalWarningsFromTraceIntervalWarnings(
    ...
    return traceTimeIntervalWarnings.stream().map(intervalWarning ->
        app.coronawarn.server.common.protocols.internal.pt.TraceTimeIntervalWarning.newBuilder()
            .setLocationGuidHash(ByteString.copyFrom(intervalWarning.getTraceLocationGuid()))
            .setStartIntervalNumber(intervalWarning.getStartIntervalNumber())
            .setTransmissionRiskLevel(intervalWarning.getTransmissionRiskLevel()).build()).collect(Collectors.toSet());
  }
