...
public class DccSignatureValidator {
   ...
   * @throws DigitalCovidCertificateSignatureException - thrown if signature verification fails or any issue occurs on
  ...
  private void verifyEcdsaSignature(String signature, Object content) throws DigitalCovidCertificateSignatureException {
    try {
      ...
      byte[] stringyfiedContentSha = byteStringDigest(stringifyObject(content), Algorithms.SHA_256);
