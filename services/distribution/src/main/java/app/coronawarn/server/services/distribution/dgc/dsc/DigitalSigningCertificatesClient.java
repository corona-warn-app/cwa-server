...
/**
 * This is a wrapper interface retrieving Digital Signing Certificates data. Used to make HTTP request to Digital
 * Signing Certificates server. Used to retrieve mock sample data from classpath.
 */
