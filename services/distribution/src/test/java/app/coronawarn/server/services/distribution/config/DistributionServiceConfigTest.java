...
public class DistributionServiceConfigTest {
  ...
  void whenDistributionConfigBeanCreatedThenPropertiesLoadedCorrectly() {
    ...
    cp.put("services.distribution.include-incomplete-days", dsc.getIncludeIncompleteDays().toString());
    cp.put("services.distribution.include-incomplete-hours", dsc.getIncludeIncompleteHours().toString());
