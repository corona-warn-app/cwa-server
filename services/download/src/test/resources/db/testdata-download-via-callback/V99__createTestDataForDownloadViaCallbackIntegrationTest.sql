...
INSERT INTO federation_batch_info(batch_tag, date, status) VALUES ('processing_fails_partially', CURRENT_DATE, 'UNPROCESSED');
INSERT INTO federation_batch_info(batch_tag, date, status) VALUES ('processing_fails', CURRENT_DATE, 'UNPROCESSED');
INSERT INTO federation_batch_info(batch_tag, date, status) VALUES ('batch_with_next_batch_tag', CURRENT_DATE, 'UNPROCESSED');
