...
import app.coronawarn.server.services.federationdownload.config.FederationDownloadServiceConfig.Client.Ssl;
import feign.Client;
...
public class CloudFeignClientProvider implements FeignClientProvider {
   ...
   */
  public CloudFeignClientProvider(FederationDownloadServiceConfig config,
