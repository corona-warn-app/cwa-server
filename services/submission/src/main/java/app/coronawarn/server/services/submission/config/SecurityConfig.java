...
public class SecurityConfig {
  ...
  private static final String SUBMISSION_ON_BEHALF_ROUTE = "/version/v1"
  ...
  public SecurityFilterChain filterChain(final HttpSecurity http) throws Exception {
    http.authorizeHttpRequests()
        ...
        .requestMatchers(HttpMethod.POST, SUBMISSION_ROUTE, SUBMISSION_ON_BEHALF_ROUTE).permitAll()
        .anyRequest().denyAll()
        .and().csrf().disable();
