...
/**
 * Thrown when the application tried to validate the TAN key. The key value of the TAN depends on
 * it's {@link AuthorizationType}. Validation is executed on
 * {@link AuthorizationType#isValidSyntax(String)}.
 */
public class IllegalTanAuthorizationKeyFormatException extends TanAuthorizationException {

  /**
   * Creates a new instance of the IllegalTanAuthorizationKeyFormatException for the specified
   * key.
