 ...
 * Some of the paramters in the CWA persisted keys can be adapted to fit the EFGS rules without
 * breaking key information consistency. This component ensures keys are adapted to the EFGS
 * requirements.
 */
@Component
public class EfgsKeyParameterAdapter {
   ...
   */
  public List<FederationUploadKey> adaptToEfgsRequirements(
      List<FederationUploadKey> pendingUploadKeys) {
